...
public class Table_Pagination_usingStream {

	public static void main(String[] args) {
			
		// Program to get the price of a element/veggie and check other pages if not present in 1st page
	    // We will use javaStreams
		// This programe is for sorting and pagination
